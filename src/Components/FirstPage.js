    ...
    return (
      <main className="flex flex-col lg:flex-row items-center   justify-center p-8 lg:p-28 space-y-8 lg:space-y-0 lg:space-x-16">
        ...
        <div className="flex flex-col space-y-5 text-center md:text-start">
          ...
          <Link href='/login'><button className="bg-[#40B59F] text-[#ffff] rounded-full px-6 py-1 block md:hidden mr-3">Login</button></Link>
          <Link href='/register'><button className="font-bold bg-[#fffff] text-[#0000000] border-2 border-[#40B59F] rounded-full px-3 py-1 block md:hidden">Register</button></Link>
          </div>
        </div>
      </main>
    );
